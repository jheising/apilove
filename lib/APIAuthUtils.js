...
class APIAuthUtils {
    ...
    static createJWT(userID, username, refreshToken, expiresIn = "1h", extraData = {}) {
        ...
        return jsonwebtoken_1.default.sign(Object.assign({ i: userID, u: username, r: refreshToken }, extraData), APIConfig_1.APIConfig.JWT_SECRET, options);
    }
}
