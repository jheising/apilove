...
const is_lambda_1 = __importDefault(require("is-lambda"));
...
APIConfig.RUN_AS_SERVER = !is_lambda_1.default;
...
APIConfig.JWT_SECRET = "65e068de-81ef-457d-b00a-82364c360226";
__decorate([
    Config_1.EnvVarSync,
...
__decorate([
    Config_1.EnvVarSync,
    __metadata("design:type", String)
], APIConfig, "S3_FILE_SERVICE_BUCKET_NAME", void 0);
__decorate([
    Config_1.EnvVarSync,
    __metadata("design:type", String)
], APIConfig, "JWT_SECRET", void 0);
